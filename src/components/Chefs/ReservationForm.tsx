...
const ReservationForm = () => {
  return (
    ...
    >
      <BadgeSwissFranc className="w-[5rem] h-[5rem] text-white mt-[2rem] mx-auto " />
      <h1 className="text-center font-bold uppercase text-[30px] md:text-[40px] lg:text-[50px]mt-[0.5] text-white">
        Reservation
      </h1>
      ...
      <div className="mt-[2rem]">
        ...
        <div className="mt-[2rem] w-[80%] text-center mx-auto">
          <button className="px-8 py-3 rounded-lg mb-[3rem] text-[16px] w-full bg-blue-950 transition-all duration-200 hover:bg-red-800 text-white">
            Book Now
          </button>
        </div>
      </div>
